...
class Coupling(AbstractBijection):
    ...
    def __init__(
        ...
        *,
        ...
        conditioner_output_size = transformer_init_params.size * (dim - untransformed_dim)

        conditioner = eqx.nn.MLP(
            in_size=untransformed_dim if cond_dim is None else untransformed_dim + cond_dim,
