...
class VAE(nnx.Module):
    ...
    class Decoder(nnx.Module):
        def __init__(self, opts, rngs):
            ...
            self.fc_dec = nnx.Sequential(
                nnx.Linear(opts.z_dim, 256, rngs=rngs),
                nnx.elu,
                nnx.Linear(256, 64 * 8 * 8, rngs=rngs),
                nnx.elu,
            )

            self.convs = nnx.Sequential(
                ResizeAndConv(64, 64, kernel_size=(4, 4), strides=(1, 1), rngs=rngs),
                nnx.elu,
                ResizeAndConv(64, 64, kernel_size=(4, 4), strides=(2, 2), rngs=rngs),
                nnx.elu,
                ResizeAndConv(64, 64, kernel_size=(4, 4), strides=(2, 2), rngs=rngs),
                nnx.elu,
                ResizeAndConv(64, 32, kernel_size=(4, 4), strides=(2, 2), rngs=rngs),
                nnx.elu,
    ...
    def __init__(self, opts={}, *, rngs: nnx.Rngs):
        ...
        self.encoder = nnx.Sequential(
            ...
            nnx.elu,
            nnx.Conv(128, 256, kernel_size=(4, 4), strides=(2, 2), rngs=rngs),
            nnx.elu,
            nnx.Conv(256, 256, kernel_size=(4, 4), strides=(2, 2), rngs=rngs),
            nnx.elu,
            nnx.Conv(256, 256, kernel_size=(4, 4), strides=(1, 1), rngs=rngs),
            nnx.elu,
        )
