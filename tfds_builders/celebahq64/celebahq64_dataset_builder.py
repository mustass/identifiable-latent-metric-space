...
class Builder(tfds.core.GeneratorBasedBuilder):
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    return self.dataset_info_from_configs(
        features=tfds.features.FeaturesDict({
            ...
            'gender': tfds.features.ClassLabel(names=['female', 'male']),
            'glasses': tfds.features.ClassLabel(names=['no_glasses', 'glasses']),
            'smile': tfds.features.ClassLabel(names=['no_smile', 'smile']),
  ...
  def _generate_examples(self, split='train'):
    ...
    def deserialization_fn(data):
      ...
      return {'image': image, 'gender': data['Male'], 'glasses': data['Eyeglasses'], 'smile': data['Smiling'], 'young': data['Young'], 'hat': data['Wearing_Hat']}
